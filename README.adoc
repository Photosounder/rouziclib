...
** https://github.com/Photosounder/rouziclib/tree/master/rouziclib/libraries/emscripten.c[emscripten.c] / https://github.com/Photosounder/rouziclib/tree/master/rouziclib/libraries/emscripten.h[emscripten.h] +
