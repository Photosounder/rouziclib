...
```
fprintf_rl(stdout, "Program returned {%.17g, %.17g}\n", ((ddouble_t *) &prog.return_real[0])->hi, ((ddouble_t *) &prog.return_real[0])->lo);
```

Which gives us the result in double-double format: `Program returned {-0.65364362086361194, 2.5846614087018284e-17}`.
