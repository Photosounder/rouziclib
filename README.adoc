...
When parsing expressions with https://github.com/codeplea/tinyexpr[TinyExpr] doesn't cut it anymore, as was the case with my image calculator, something else is needed, something that allows you to type in interpreted programs. Since it was made with my image calculator in mind you maybe think of it as a kind of shader language, except that it runs on the CPU.
