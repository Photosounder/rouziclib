...
Higher precision (usually with maximum errors around the 10^-33^ - 10^-30^ range) approximations double-double arithmetic for functions such as the square root, sine/cosine, arcsin, exp/exp2, erf.
