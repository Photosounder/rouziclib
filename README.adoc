...
Functions for hashing based on https://github.com/Cyan4973/xxHash/[xxHash]. I didn't like how big and complicated the original code was so I made a much smaller, simpler and more readable version in link:rouziclib/libraries/orig/xxh64.c[xxh64.c].
...
Draw Gaussian-antialiased circles (full or hollow), hollow rectangles and chamfered (angular) rectangles, rounded rectangles, dashed lines, Gaussian gradients and dots, hollow triangles, mouse cursors, as well as full triangles and concave tetragons.
