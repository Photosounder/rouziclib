...
extern int ctrl_textedit_fullarg(framebuffer_t fb, zoom_t zc, mouse_t mouse, vector_font_t *font, double drawing_thickness, textedit_t *te, rect_t box, col_t colour);
extern void draw_textedit_cursor(framebuffer_t fb, xy_t offset, double scale, int bidi, int bidi_change, double drawing_thickness);
