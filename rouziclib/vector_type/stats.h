...
extern double calc_strwidth_len(vector_font_t *font, uint8_t *string, double scale, const int mode, int32_t len);
extern double calc_strwidth(vector_font_t *font, uint8_t *string, double scale, const int mode);
...
extern double find_string_maxwidth_and_nlines(vector_font_t *font, uint8_t *string, const int mode, int *nlines, int empty_lines_count);
extern double calc_strwidth_firstline(vector_font_t *font, uint8_t *string, double scale, const int mode, int32_t len, int *sonl);
