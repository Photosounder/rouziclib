...
extern int xy_array_to_bezier_seg_array(xy_t *pa, int p_count, bezier_seg_t **bap, size_t *ba_as, int loops);
...
extern double bezier_seg_array_eval_x(bezier_seg_t *ba, int b_count, double x, int ret_nan);
