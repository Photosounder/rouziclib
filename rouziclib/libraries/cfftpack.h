...
extern void cfft_1D_r2c_padded_fft(cfft_plan_t *plan, fft_real_t *in, void **pout, size_t *out_as, int in_n, int out_n);
extern void cfft_2D_r2c_padded_fft(cfft_plan_t *plan, fft_real_t *in, void **pout, size_t *out_as, xyi_t in_dim, xyi_t out_dim);
