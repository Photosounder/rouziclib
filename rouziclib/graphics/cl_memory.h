...
extern uint64_t cl_add_data_table_entry(framebuffer_t *fb, size_t table_index, size_t prev_end, void *buffer, size_t size);
extern uint64_t cl_add_buffer_to_data_table(framebuffer_t *fb, void *buffer, size_t elem_count, size_t elem_size);
