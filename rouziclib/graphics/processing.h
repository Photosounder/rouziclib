...
extern float *get_pixel_address_contig(void *ptr, xyi_t dim, xyi_t ip);
extern float *get_pixel_address_2d(void *ptr, xyi_t dim, xyi_t ip);
extern void blit_scale_float(void *bg, xyi_t bg_dim, void *fg, xyi_t fg_dim, const int channels, xy_t pscale, xy_t pos, float * (*get_pix_f)(void*,xyi_t,xyi_t));
