void draw_rect_full_cl(framebuffer_t fb, rect_t box, double radius, frgb_t colour, double intensity)
{
#ifdef RL_OPENCL
	float *df;
	double grad;
...
void draw_rect_full(framebuffer_t fb, rect_t box, double radius, col_t colour, double intensity)
{
