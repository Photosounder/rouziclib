...
extern mipmap_t alloc_mipmap(raster_t r, xyi_t tilesize, xyi_t mindim, const int mode);
extern mipmap_t alloc_mipmap_defaults(raster_t r, const int mode);
...
extern void update_mipmap_sublevels_fast(mipmap_t m, const int mode);
extern void update_raster_to_mipmap_fast(mipmap_t m, raster_t r, const int mode);
