...
extern float *load_sound_fl32_select_chan(const char *in_path, size_t *sample_count, int *channel_count, int *samplerate, int sel_chan);
extern sound_sample_t load_sound_sample(const char *in_path, int sel_chan);
