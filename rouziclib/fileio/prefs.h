...
extern char *pref_handle_string(pref_file_t *pf, char *loc, char *string_prefix, char *string, int mode_set);
extern char *pref_get_string(pref_file_t *pf, char *loc, char *def_string);
