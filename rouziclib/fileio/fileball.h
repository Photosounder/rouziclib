...
extern size_t fileball_make_uncompressed_file(char *out_path, char **paths, int path_count, const int depth);
extern buffer_t fileball_make_z(char **paths, int path_count, const int depth);
extern size_t fileball_make_z_file(char *out_path, char **paths, int path_count, const int depth);
extern size_t fileball_make_header_file(char *out_path, char **paths, int path_count, const int depth);
