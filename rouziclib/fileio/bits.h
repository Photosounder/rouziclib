...
extern uint64_t get_bits_in_stream(const uint8_t *stream, size_t start_bit, int bit_count);
extern uint64_t get_bits_in_stream_inc(const uint8_t *stream, size_t *start_bit, int bit_count);
