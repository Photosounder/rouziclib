...
extern uint64_t get_bits_in_stream_inc(uint8_t *stream, int64_t *start_bit, int bit_count);
extern void set_bits_in_stream(uint8_t *stream, int64_t start_bit, int bit_count, uint64_t b);
