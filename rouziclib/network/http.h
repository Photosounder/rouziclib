...
extern size_t http_get(const char *url, int timeout, int retry, uint8_t **data, size_t *data_alloc);
extern size_t http_get_buf(const char *url, int timeout, int retry, buffer_t *buf);
