...
extern double short_gaussian_window_range(double w, double p);
extern double short_gaussian_window(double x, double range, double w, double p);
extern double short_gaussian_window_sq(double x, double range, double w);
